...
stage1 - stage4 与 parser-stage 为 5 个基础关卡，你需要通过它们以拿到一定的分数（20%）。
stage5 为升级关卡，如果你学有余力，完成它们可以减少期末考试在总评中所占的比重（完整完成可以获得占总评 5% 的成绩并替代期末考试对应权重）。
stage6 为进阶关卡，如果你依然学有余力，你可以在这里实现一些编译优化（完整完成可以获得占总评 5% 的成绩并替代期末考试对应权重）。注意，你需要在完成 stage5 后才能尝试 stage6，否则无法获得对应分数。
