...
对于 git 的安装和使用请同学们自行查阅相关资料，也可以参考[这里](https://www.liaoxuefeng.com/wiki/896043488029600) 。每一个参考实现都是一个 git 分支，且都以 commit 的形式提供了每一个 lab 的示例。同学们可以通过 git log 查看提交历史，通过 git checkout 查看每一个 lab 的实现，或者通过 git diff 对比两个 lab 之间的差异。
