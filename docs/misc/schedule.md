...
- 第四周周日（10.11）：Stage 1 截止 常量表达式（占比：4%）

- 第六周周日（10.25）：Stage 2 截止 变量和作用域（占比：4%）

- 第八周周日（11.8）：Parser Stage 截止 手动语法分析器（占比：4%）

- 第十周周日（11.22）：Stage 3 截止 控制语句（占比：4%）

- 第十四周周日（12.20）：Stage 4 截止 函数（占比：4%）
    - 函数部分由于难度较大，给大家预留了三周多时间，请大家不要等到最后一周再开始。

## 选做部分：
选做部分难度较大，且时间较紧，同学可能需要提前一些开始才能保证完成。

- 第十五周周日（12.27）：Stage 5 截止 全局变量和数组（占比：5%）

- 第十六周周日（1.3）：Stage 6 截止 寄存器分配与代码优化（占比：5%）
